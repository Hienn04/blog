                ...
                <div class="card mb-3">
                  ...
                  <div class="card-body">
                    ...
                    <div class="pt-4 pb-2">
                      ...
                      <p class="text-center small">Nhập tên đăng nhập và mật khẩu của bạn để đăng nhập</p>
                    </div>
                    ...
                    <form class="row g-3 needs-validation" novalidate>
                      ...
                      <div class="col-12">
                        <p class="small mb-0">Bạn chưa có tài khoản? <a href="pages-register.html">Tạo một tài khoản</a></p>
                      </div>
                    </form>
